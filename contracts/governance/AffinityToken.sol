...
contract AffinityToken is ERC20, ERC20Burnable, AccessControl, ERC20Permit, ERC20Votes {
    ...
    function grantRoleMinter(address _account) public onlyRole(MINTER_ROLE) {
        require(_account != address(0),"cannot grant role to 0x00 address");
        grantRole(MINTER_ROLE, _account);
    }

    function hasRoleMinter(address _account) public view onlyRole(MINTER_ROLE) returns (bool) {
